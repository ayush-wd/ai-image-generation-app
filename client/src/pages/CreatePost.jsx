    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px]
         max-w[500px] '>
          Create imaginaitve and visually stunnig images through DALLE AI and share them with the community
        </p>
      </div>

      <form onSubmit={handleSubmit} className="mt-16 max-3-3xl">
        <div className="flex flex-col gap-5">
          ...
          handleSurpriseMe={handleSurpriseMe}
           ...
           text-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>Once you have created the 
            image, you can 
            share the image with the community</p>
            <button type='submit'
